...
class TfbInvolvedDriverLastName extends StatelessWidget {
  const TfbInvolvedDriverLastName({
  ...
  Widget build(BuildContext context) {
    return ValidatingFormField(
      labelText: context.getLocalizationOf.insuredDriverLastNameFieldLabel,
      type: ValidationType.involvedDriverLastName,
      isRequired: true,
