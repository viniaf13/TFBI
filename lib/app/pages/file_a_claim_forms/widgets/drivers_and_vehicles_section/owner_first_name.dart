...
class TfbOwnerFirstName extends StatelessWidget {
  const TfbOwnerFirstName({
  ...
  Widget build(BuildContext context) {
    return ValidatingFormField(
      labelText: context.getLocalizationOf.ownerFirstNameFieldLabel,
      type: ValidationType.firstName,
