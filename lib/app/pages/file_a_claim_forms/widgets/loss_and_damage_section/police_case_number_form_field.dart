...
class PoliceCaseNumberFormField extends StatelessWidget {
  const PoliceCaseNumberFormField({
  ...
  Widget build(
    ...
    return ValidatingFormField(
      ...
      onChanged: onChanged,
      labelText: context.getLocalizationOf.policeCaseNumberFormField,
      type: ValidationType.policeCaseNumber,
    );
  }
}
