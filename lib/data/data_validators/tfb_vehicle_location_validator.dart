...
class TfbVehicleLocationValidator extends DataValidator<String> {
  TfbVehicleLocationValidator({required this.errorMessage});

  factory TfbVehicleLocationValidator.localized(
    BuildContext context,
  ) =>
      TfbVehicleLocationValidator(
        errorMessage:
