...
class TfbVehicleLicensePlateNumberValidator extends DataValidator<String> {
  TfbVehicleLicensePlateNumberValidator({required this.errorMessage});

  factory TfbVehicleLicensePlateNumberValidator.localized(
