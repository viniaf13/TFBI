...
class TfbEnvironmentConfigurationProduction
    extends TfbEnvironmentConfiguration {
  @override
  String get apiBaseUrl => kProductionApiBaseUrl;
  ...
  TfbAnalyticsConfig get analyticsConfig => TfbAnalyticsConfig(
        ...
        mixpanelToken: MixpanelProjectToken.prod,
      );
