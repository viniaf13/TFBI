...
void main() {
  ...
  testWidgets('Involved vehicle plate number field label', (tester) async {
    await tester.pumpWidget(
      TfbWidgetTester(
        child: Scaffold(
          body: TfbInvolvedVehiclePlateNumber(
  ...
  testWidgets('should not show any error message with valid string',
    ...
    final textInputField = find.byType(TfbInvolvedVehiclePlateNumber);
    ...
    expect(
      find.text(AppLocalizationsEn().minMaxLengthValidationMessage(10, 2)),
      findsNothing,
    );
  });
